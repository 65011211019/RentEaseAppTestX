                  ...
                  <div className="flex flex-col h-full">
                    ...
                    <div className="flex-1 flex flex-col justify-between p-5">
                      ...
                      <div className="mt-4 flex justify-end">
                        <Link
                          to={`/owner/rentals/${rental.id}`}
                          className="inline-flex items-center gap-2 px-4 py-2 rounded-lg text-white bg-gradient-to-r from-blue-500 to-indigo-500 hover:from-blue-600 hover:to-indigo-600 font-semibold shadow transition-all duration-150 focus:outline-none focus:ring-2 focus:ring-blue-400"
                        >
                          <svg className="w-5 h-5" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" d="M15 19l-7-7 7-7" /></svg>
                          {t('ownerRentalHistoryPage.rentalCard.viewDetails')}
                        </Link>
                      </div>
                    </div>
                  </div>
