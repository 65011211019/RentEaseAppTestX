export const ROUTE_PATHS = {
  ...
  // Claims & Returns
  CLAIMS_HISTORY: '/claims', // User's general view of their claims
  CLAIM_DETAIL: '/claims/:claimId', // Detail of a specific claim by user
  CLAIM_MANAGEMENT: '/claim-management/:claimId', // For active interaction/mediation

  // Complaints
  SUBMIT_COMPLAINT: '/contact/complaint', 
  ...
  ADMIN_MANAGE_STATIC_CONTENT: '/admin/content',
  ADMIN_REPORTS: '/admin/reports',
  ADMIN_MANAGE_CLAIMS: '/admin/claims', 
  ADMIN_CLAIM_DETAIL: '/admin/claims/:claimId',
  ADMIN_MANAGE_COMPLAINTS: '/admin/complaints',
  ADMIN_COMPLAINT_DETAIL: '/admin/complaints/:complaintId',
